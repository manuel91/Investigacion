...
public class FormularioCasos extends javax.swing.JFrame {
    ...
    public FormularioCasos(Usuario user, int typeU) {
        ...
        this.typeU = typeU;
        this.user = user;
        this.user.creadorI = new RegistrarInvestigacion();
        this.user.creadorR = new RegistrarRobo();
        this.user.creadorF = new RegistrarFraude();
    }
    ...
    private void sendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendActionPerformed
        ...
        switch(typeC){
            case 0:
                aux = user.creadorR.FactoryMethod(datos, user.con);
                aux.RegistrarCaso();
                break;
            case 1:
                aux = user.creadorF.FactoryMethod(datos, user.con);
                aux.RegistrarCaso();
                break;
            case 2:
                aux = user.creadorI.FactoryMethod(datos, user.con);
                aux.RegistrarCaso();
                break;
        }
